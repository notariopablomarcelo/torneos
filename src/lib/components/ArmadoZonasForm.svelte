...
<form onsubmit={handleSubmit}>
	{#if idPasoActual === 'algoritmo'}
		<div class="space-y-4">
			<div>
				<h3 class="text-base font-semibold text-gray-900">¿Cómo distribuir las parejas?</h3>
				<p class="mt-1 text-sm text-gray-500">Elegí el método para repartir las inscripciones en zonas.</p>
			</div>
			...
			<div class="space-y-2">
				...
				>
					<div class="flex items-start gap-2">
						<i
							class="bi {algoritmo === 'snake' ? 'bi-check-circle-fill text-brand-500' : 'bi-circle text-gray-300'} mt-0.5"
						></i>
						<div>
							<p class="font-medium text-gray-900">Snake / serpentina</p>
				...
				>
					<div class="flex items-start gap-2">
						<i
							class="bi {algoritmo === 'random' ? 'bi-check-circle-fill text-brand-500' : 'bi-circle text-gray-300'} mt-0.5"
						></i>
						<div>
							<p class="font-medium text-gray-900">Random / sorteo libre</p>
							<p class="mt-0.5 text-xs text-gray-600">
	...
	{:else if idPasoActual === 'tamano'}
		<div class="space-y-4">
			<div>
				<h3 class="text-base font-semibold text-gray-900">¿Cuántas parejas por zona?</h3>
				<p class="mt-1 text-sm text-gray-500">Si N no divide exacto, completamos con zonas del otro tamaño.</p>
			</div>
			...
			<div class="space-y-2">
				...
				>
					<div class="flex items-start gap-2">
						<i
							class="bi {tamanoStr === '3' ? 'bi-check-circle-fill text-brand-500' : 'bi-circle text-gray-300'} mt-0.5"
						></i>
						<div>
							<p class="font-medium text-gray-900">Preferir 3 <span class="text-xs font-normal text-gray-500">(FAP)</span></p>
							<p class="mt-0.5 text-xs text-gray-600">
				...
				>
					<div class="flex items-start gap-2">
						<i
							class="bi {tamanoStr === '4' ? 'bi-check-circle-fill text-brand-500' : 'bi-circle text-gray-300'} mt-0.5"
						></i>
						<div>
							<p class="font-medium text-gray-900">Preferir 4</p>
							<p class="mt-0.5 text-xs text-gray-600">
			...
			<div class="rounded-lg border border-gray-200 bg-gray-50 p-3 text-sm">
				<p class="mb-1 font-medium text-gray-700">Con {cantidadInscripciones} inscripciones:</p>
				{#if previsualizacion.ok}
	...
	{:else if idPasoActual === 'modalidad'}
		<div class="space-y-4">
			<div>
				<h3 class="text-base font-semibold text-gray-900">Modalidad de las zonas de 4</h3>
				<p class="mt-1 text-sm text-gray-500">Aplica solo a las zonas de 4 que se generen. Las de 3 son siempre round-robin.</p>
			</div>
			...
			<div class="space-y-2">
				...
				>
					<div class="flex items-start gap-2">
						<i
							class="bi {modalidadZona4 === 'todosContraTodos' ? 'bi-check-circle-fill text-brand-500' : 'bi-circle text-gray-300'} mt-0.5"
						></i>
						<div>
				...
				>
					<div class="flex items-start gap-2">
						<i
							class="bi {modalidadZona4 === 'dobleOportunidad' ? 'bi-check-circle-fill text-brand-500' : 'bi-circle text-gray-300'} mt-0.5"
						></i>
						<div>
	...
	{:else if idPasoActual === 'clasifican'}
		<div class="space-y-4">
			<div>
				<h3 class="text-base font-semibold text-gray-900">¿Cuántas pasan al bracket?</h3>
				<p class="mt-1 text-sm text-gray-500">Define qué tan exigente es la fase de zonas.</p>
			</div>
			...
			<div class="space-y-2">
				...
				>
					<div class="flex items-start gap-2">
						<i
							class="bi {clasificanStr === '2' ? 'bi-check-circle-fill text-brand-500' : 'bi-circle text-gray-300'} mt-0.5"
						></i>
						<div>
							<p class="font-medium text-gray-900">2 por zona <span class="text-xs font-normal text-gray-500">(FAP)</span></p>
							<p class="mt-0.5 text-xs text-gray-600">
				...
				>
					<div class="flex items-start gap-2">
						<i
							class="bi {clasificanStr === '1' ? 'bi-check-circle-fill text-brand-500' : 'bi-circle text-gray-300'} mt-0.5"
						></i>
						<div>
							<p class="font-medium text-gray-900">1 por zona</p>
							<p class="mt-0.5 text-xs text-gray-600">
				...
				{#if hayZonasDe4}
					...
					>
						<div class="flex items-start gap-2">
							<i
								class="bi {clasificanStr === '3' ? 'bi-check-circle-fill text-brand-500' : 'bi-circle text-gray-300'} mt-0.5"
							></i>
							<div>
								<p class="font-medium text-gray-900">3 por zona</p>
								<p class="mt-0.5 text-xs text-gray-600">
			...
			<div class="rounded-lg border border-gray-200 bg-gray-50 p-3 text-sm">
				<p class="mb-1 font-medium text-gray-700">Vas a armar:</p>
				{#if previsualizacion.ok}
					<p class="text-gray-600">
						{previsualizacion.zonas3 + previsualizacion.zonas4} zonas
						{#if previsualizacion.zonas4 > 0}
